...
uint256 hashGenesisBlock("0x9a043feb0d9b0458ec79133c48dcb81e1366378f6f0f5c4f29030d63b12014cf");
...
const string strMessageMagic = "chris200x9coin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // chris200x9coin: 1 days
static const int64 nTargetSpacing = 120; // chris200x9coin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal chris200x9coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "chris200x9coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "crhis200x9";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1300009999; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0x1c53bbb173f4ecf3892b2e6acfbeef8d566500a9107655acda39818df44534e5"));
